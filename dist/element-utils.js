...
const elements = Object.keys(elementToTypeMap);
 ...
 */
export function canBeSpelledWithElements(wordOrPhrase) {
    ...
    for (const word of words) {
        ...
        if (!permutations)
            return false; // If any word can't be spelled, the whole phrase can't be spelled
